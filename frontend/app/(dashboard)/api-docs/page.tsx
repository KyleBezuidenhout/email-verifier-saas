...
const endpoints: Endpoint[] = [
  ...
  },
  {
    ...
    description: "Find a verified business email for a person given their name and company website. Returns valid, catchall, or not_found. Charges 1 credit per call regardless of result. Supports both full name and first/last name inputs. Names are automatically parsed (honorifics, suffixes, and middle names are stripped).",
    authRequired: true,
    bodyParams: [
      { name: "name", type: "string", required: false, description: "Full name (e.g., 'Dr. John Michael Smith Jr.'). Parsed into first/last automatically. Provide this OR first_name + last_name." },
      { name: "first_name", type: "string", required: false, description: "First name. Required if 'name' is not provided." },
      { name: "last_name", type: "string", required: false, description: "Last name. Required if 'name' is not provided." },
      { name: "company_website", type: "string", required: true, description: "Company website (e.g., 'https://acme.com' or 'acme.com'). Domain is extracted automatically." },
    ],
    requestExample: {
      name: "John Smith",
