...
export default function DashboardPage() {
  ...
  // Live cookie-validation state. Start Scraping is gated on cookieStatus === "valid"
      ...
      <div className="glass-card px-6 py-3 mb-6">
        {validationEnabled && cookieStatus === "validating" ? (
          <button
            type="button"
            disabled
            className="w-full px-4 py-3 bg-dashboard-accent/20 border border-dashboard-accent/40 text-dashboard-accent rounded-lg flex items-center justify-center gap-2 font-medium cursor-not-allowed"
          >
          ...
          <div className="relative glass-card p-6 shadow-2xl max-w-md w-full mx-4" style={{ background: 'rgba(13, 15, 18, 0.9)' }}>
            ...
            <input
              ...
              onChange={(e) => {
                ...
                // Any edit invalidates the previous verdict — user must click
                // Save Cookie again to re-validate and re-enable Start Scraping.
            ...
            <div className="flex gap-3">
              <button
                onClick={async () => {
                  ...
                  // "Validating..." button on the main page while the
                  // backend confirms the cookie against Vayne.
                  setShowAuthModal(false);
                ...
                disabled={!linkedinCookie.trim()}
                className="flex-1 px-4 py-2 border border-dashboard-accent text-dashboard-accent bg-transparent rounded-lg hover:bg-dashboard-accent/10 transition-colors text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Save Cookie
              </button>
